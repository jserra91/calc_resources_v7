...
(function () {
    ...
    function ObjPlaneta() {
        ...
        this.getTotalM = function() {
            ...
            return base + mina + geo + ofi + plasma + amplificador + parseInt(this.metal_taladrador) + parseInt(this.metal_classe);
        }
        ...
        this.getTotalC = function() {
            ...
            return base + mina + geo + ofi + plasma + amplificador + parseInt(this.cristal_taladrador) + parseInt(this.cristal_classe);
        }
        ...
        this.getTotalD = function() {
            ...
            return mina + geo + plasma + ofi + (amplificador - fusion) + parseInt(this.deuterio_taladrador) + parseInt(this.deuterio_classe);
        }
        ...
        if ( numPlanets > 0 ) { 
            ...
            for(var k = 0; k < sep.length; k++){
                if(sep[k].length > 3) {
                    ...
                    totalM = baseM + minaM + geoM + ofiM + plasmaM + amplificadoresM + taladradorM + classeM;
                    totalC = baseC + minaC + geoC + ofiC + plasmaC + amplificadoresC + taladradorC + classeC;
                    totalD = baseD + minaD + geoD + ofiD + plasmaD + (amplificadoresD - gastoFusion) + taladradorD + classeD;
            ...
            tabla += '<tr class="" align="right" id="detalleMetal_7" style="display:none"><td class="label"> Classe </td><td class="">' + mostrarNumero(classeM) + '</td><td class="">' + mostrarNumero(classeM*24) + '</td><td class="">' + mostrarNumero(classeM*168) + '</td><td class="">' + mostrarNumero(classeM*720) + '</td></tr>';
            ...
            tabla += '<tr class="" align="right" id="detalleCristal_7" style="display:none"><td class="label"> Classe </td><td class="">' + mostrarNumero(classeC) + '</td><td class="">' + mostrarNumero(classeC*24) + '</td><td class="">' + mostrarNumero(classeC*168) + '</td><td class="">' + mostrarNumero(classeC*720) + '</td></tr>';
